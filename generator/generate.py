...
class Track:
    ...
    def __init__(self, name, length, parking=True):
...
class ShuntingYard:
    ...
    def __init__(self, 
                 ...
                 goal_states: GoalStates = GoalStates.HAS_PARKED,
    ...
    def generate_instance(self):
        ...
        filename = Path("../instances/" + self.instance_name + "_" + str(len(self.trains)) + "t.pddl")
    ...
    def _generate_init_numeric(self):
        ...
        instance_text += [f"\t(parking_allowed {track.name})" for track in self.tracks if track.parking and track.length >= max_train_length]
        instance_text += [""]
