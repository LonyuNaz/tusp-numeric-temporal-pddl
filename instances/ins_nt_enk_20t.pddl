...
(= (num_consecutive_movements) 0)
	...
	(= (num_trains_on_track track_entry) 20)
	...
	(= (stack_Bside_distance_to_end_of_track track_entry) 3200)
	...
	(is_active train_ddz_16)
	(is_active train_ddz_17)
	(is_active train_ddz_18)
	(is_active train_ddz_19)
	(is_active train_ddz_20)
	...
	(is_available train_ddz_16)
	(is_available train_ddz_17)
	(is_available train_ddz_18)
	(is_available train_ddz_19)
	(is_available train_ddz_20)
	...
	(= (train_length train_ddz_16) 160)
	(= (train_length train_ddz_17) 160)
	(= (train_length train_ddz_18) 160)
	(= (train_length train_ddz_19) 160)
	(= (train_length train_ddz_20) 160)
	...
	(train_at train_ddz_16 track_entry)
	(train_at train_ddz_17 track_entry)
	(train_at train_ddz_18 track_entry)
	(train_at train_ddz_19 track_entry)
	(train_at train_ddz_20 track_entry)
	...
	(= (train_distance_to_end_of_track train_ddz_16) 2400)
	(= (train_distance_to_end_of_track train_ddz_17) 2560)
	(= (train_distance_to_end_of_track train_ddz_18) 2720)
	(= (train_distance_to_end_of_track train_ddz_19) 2880)
	(= (train_distance_to_end_of_track train_ddz_20) 3040)
...
(:goal (and 
	...
	(is_parking train_ddz_16)
	(is_parking train_ddz_17)
	(is_parking train_ddz_18)
	(is_parking train_ddz_19)
	(is_parking train_ddz_20)
